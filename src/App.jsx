...
function App() {
  ...
  return (
    ...
    <div className="bg-gradient-to-br from-green-200 via-white to-green-100 text-gray-900 font-sans flex flex-col min-h-screen">
     
      {/* Note - I might remove the gradient green bg, its temporary */}
